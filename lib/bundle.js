...
/***/ function(module, exports, __webpack_require__) {
	...
	Game.prototype.addCars = function () {
	  for (let i = 0; i < Constants.NUM_CARS; i++) {
	    this.add(new Car({ game: this, type: undefined }));
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function randomPosition(direction){
		const row = random(Constants.ROWS[this.game.level]);
		let x,y;
...
/***/ function(module, exports) {
	...
	const Util = {
	  ...
	  checkCollide(obj1, obj2){
	    if (Math.abs(obj1.pos[0] - obj2.pos[0]) < 50 &&
	      obj1.pos[1] === obj2.pos[1]){
...
/***/ function(module, exports, __webpack_require__) {
	...
	function paintRow(ctx,img, cols, row){
	  for (let i = 0; i < cols; i++) {
	    ctx.drawImage(img, i*50, Constants.DIM_Y - (row*50));
	  }
	}
